...
import com.meta.p3ts.domain.PagamentoComCartao;
import com.meta.p3ts.domain.Pedido;
import com.meta.p3ts.domain.Produto;
import com.meta.p3ts.domain.enums.EstadoPagamento;
import com.meta.p3ts.domain.enums.Perfil;
...
import com.meta.p3ts.repositories.ItemPedidoRepository;
import com.meta.p3ts.repositories.PagamentoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "rreisp@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA, pe.encode("123"));

		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "rreisp@ufop.edu.br", "31628382740", TipoCliente.PESSOAFISICA,
				pe.encode("123"));
